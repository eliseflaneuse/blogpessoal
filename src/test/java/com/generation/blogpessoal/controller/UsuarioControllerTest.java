...
public class UsuarioControllerTest {
	...
	@Test
	@DisplayName("Não deve perrmitir duplicação do Usuário")
	public void naoDeveDuplicarUsuario() {
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Maria da Silva", "mariasilva@email.com.br", "13465278", "-"));
	...
	public void deveAtualizaruUmUsuario() {
		...
		Usuario usuarioUpdate = new Usuario( usuarioCadastrado.get().getId(), 
				"Juliana Andrews Ramos", "julianaramos@email.com.br", "juliana1l23" , "-");
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Sabrina Sanches", "sabrinasanches@email.com.br", "sabrina1i23", "-"));
